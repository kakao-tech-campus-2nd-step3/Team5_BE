...
public class YoutubeService {
    ...
    // 특정 카테고리의 유튜브 쇼츠 추출
    public List<YoutubeResponse> getShortsByCategory(String tag) throws IOException {
        // 필요한 값들만 불러오도록 최소한의 필드 요청
        String url = YOUTUBE_API_URL + "?part=snippet&fields=items(id(videoId),snippet(publishedAt, title, channelId, thumbnails(default(url))))&q=쇼츠, " + tag
